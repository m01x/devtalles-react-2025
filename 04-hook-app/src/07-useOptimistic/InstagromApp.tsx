...
//Id distinto para los comentarios..
let lastId = 2;
  ...
  const handleAddComment = async (formData : FormData) => {
    ...
    addOptimisticComment(messageText);
      ...
      startTransition( async () => {
          //Simulemos una espera de algun servidor o API
    ...
    <div className="bg-slate-700 h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <button
            type="submit"
            disabled={isPending}
            className={`text-white p-2 rounded-md w-full transition-all ${isPending ? 'bg-gray-400' : 'bg-blue-500'}`}
        >
            Enviar
        </button>
      </form>
